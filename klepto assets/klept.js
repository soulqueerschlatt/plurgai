...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#text05', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#image03', { style: 'tilt-right', speed: 1500, intensity: 8, delay: 0, replay: false });
		onvisible.add('#text06', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#text07', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#image04', { style: 'tilt-right', speed: 1500, intensity: 8, delay: 0, replay: false });
		onvisible.add('#text08', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#text09', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#image05', { style: 'tilt-right', speed: 1500, intensity: 8, delay: 0, replay: false });
		onvisible.add('#text10', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#text11', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#image06', { style: 'tilt-right', speed: 1500, intensity: 8, delay: 0, replay: false });
		onvisible.add('#text12', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#text13', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#image07', { style: 'tilt-right', speed: 1500, intensity: 8, delay: 0, replay: false });
		onvisible.add('#text14', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#text15', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#image08', { style: 'tilt-right', speed: 1500, intensity: 8, delay: 0, replay: false });
		onvisible.add('#text16', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#text17', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#image02', { style: 'tilt-right', speed: 1500, intensity: 8, delay: 0, replay: false });
		onvisible.add('#text04', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#text03', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#image01', { style: 'tilt-right', speed: 1500, intensity: 8, delay: 0, replay: false });
		onvisible.add('#text02', { style: 'fade-right', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#text01', { style: 'fade-right', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#buttons01', { style: 'fade-up', speed: 1000, intensity: 3, delay: 125, stagger: 125, staggerSelector: ':scope > li', replay: false });
